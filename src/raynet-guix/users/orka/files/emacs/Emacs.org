...
#+begin_src emacs-lisp :tangle modules/dw-helix.el
  ...
  (use-package helix
    ...
    (with-eval-after-load 'which-key
      ...
      (define-key helix-space-map "N" '("Roam Node Find" . org-roam-node-find))

      ;; Notes (n) sub-menu
      (define-prefix-command 'dw/helix-notes-map)
      (define-key helix-space-map "n" '("notes" . dw/helix-notes-map))
      (define-key dw/helix-notes-map "a" '("Org Agenda" . org-agenda))
      (define-key dw/helix-notes-map "n" '("Roam Node Find" . org-roam-node-find))
      (define-key dw/helix-notes-map "c" '("Org Capture" . org-capture))
