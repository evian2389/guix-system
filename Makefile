...
#export GUILE_LOAD_PATH := $(PROFILE_DIR)/profile/share/guile/site/$(GUILE_VERSION)
...
GUIX_TM_BASE = GUILE_LOAD_PATH="$(PROFILE_DIR)/profile/share/guile/site/$(GUILE_VERSION)" guix time-machine --debug=4
